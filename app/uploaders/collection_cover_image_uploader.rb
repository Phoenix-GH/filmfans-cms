class CollectionCoverImageUploader < CarrierWave::Uploader::Base
  ...
  def zoom_and_crop
    ...
    if model.class.to_s == 'CollectionCoverImage' && model.respond_to?(:specification) && model.specification['crop_x'].present?
      manipulate! do |img|
        oriWidth = img[:width]
