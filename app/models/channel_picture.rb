class ChannelPicture < ActiveRecord::Base
  belongs_to :channel, inverse_of: :picture

  mount_uploader :file, ChannelPictureUploader
  ...
  def cropper_data
    {
        ...
        update_url: "/panel/channel_pictures/#{id}",
